  ...
  return (
    <div className="flex bg-[#f6f2eb] h-auto justify-center py-10">
      <div className="md:flex">
        ...
        <div className="flex flex-col items-center md:items-start md:pt-20">
          <p className="uppercase font-bold text-primary">Introduction</p>
          <h3 className="md:text-8xl text-4xl text-center md:text-left font-black md:w-[500px] my-2 text-primary">
