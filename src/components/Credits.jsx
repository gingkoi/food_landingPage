...
export default function Credits() {
  return (
    <div className="bg-primary text-white py-12">
      <h2 className="text-2xl xl:text-8xl font-black text-center">
        WHAT MAKES BANZA BETTER?
      </h2>
      <div className="flex flex-col items-center xl:flex-row xl:justify-center xl:space-x-10 my-16">
        <div className=" text-center flex flex-col items-center">
          <AiOutlineHeart size={100} />
          <p className="text-2xl font-medium">MADE FROM</p>
          <p className="font-black text-6xl">CHICKPEAS</p>
          <p className="xl:text-3xl text-2xl font-light">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <p className="font-black xl:text-6xl text-5xl">THE GOOD STUFF</p>
          <p className="xl:text-3xl text-xl font-light">
